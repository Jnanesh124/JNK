        ...
        for msg in msgs:
            ...
            try:
                ...
                try:
                    ...
                    await message.reply_text(f"⚠️ **Error:** Unable to send file. The file may have been deleted or is no longer available.\n\n**Error Details:** {str(e)}")
